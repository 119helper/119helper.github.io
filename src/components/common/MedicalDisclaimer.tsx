 ...
 */
export default function MedicalDisclaimer({ source, revisedYear, note, sourceUrl }: MedicalDisclaimerProps) {
  return (
    <div
      role="alert"
    ...
    >
      ...
      <div className="text-sm leading-relaxed">
        ...
        <p className="text-on-surface-variant mt-1">
          출처: {sourceUrl ? (
            <a href={sourceUrl} target="_blank" rel="noopener noreferrer" className="font-bold underline">
              {source}
            </a>
          ) : source} ({revisedYear})
        </p>
