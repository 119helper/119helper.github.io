...
import { applyCors, corsHeaders, isAppTokenRequired, isAppTokenValid, isOriginAllowed, sanitizeStringParam } from './cors';
...
describe('isOriginAllowed', () => {
  ...
  it('overwrites route CORS and applies security headers to direct responses', async () => {
    const response = applyCors(new Response('ok', {
      headers: {
