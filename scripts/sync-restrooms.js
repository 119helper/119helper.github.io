...
function restroomFacilityFromAddressPoint(item, point) {
  ...
  return {
    ...
    coordinateSourceTermsUrl: point.sourceTermsUrl,
  ...
  manifest.datasets.restrooms = {
    ...
    addressPointOverlays: [
      ...
      ...metadata.hostAddressPointIndex.sources.map(source => ({
        ...
        validScopedRowsByCity: source.validScopedRowsByCity,
        minimumValidScopedRowsByCity: source.minimumValidScopedRowsByCity,
        minimumLatestSourceDate: source.minimumLatestSourceDate,
